...
def successTokenSend(address,tokenAddress,data):
    ...
    }).transfer(address, web3.toWei(the_contract.call().totalSupply(), "ether"),web3.toHex(data))
    return json.dumps({"code": 200, "msg": "send ok", "hash": hash})

print (successTokenSend("0x736E12498fce01c8858B607fa2FC6349826533C1","0x4b2C141C808142Be22Cc713cCB0e1Bee3619b35E","测试一下"))